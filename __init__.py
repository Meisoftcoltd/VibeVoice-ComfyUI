...
if check_embedded_vibevoice() and ensure_dependencies():
    try:
        ...
        # Training nodes
        NODE_CLASS_MAPPINGS["VibeVoice_Dataset_Preparator"] = VibeVoice_Dataset_Preparator
        NODE_DISPLAY_NAME_MAPPINGS["VibeVoice_Dataset_Preparator"] = "🎙️ VibeVoice Dataset Preparator"
